  ...
  const fetchRequests = async () => {
    ...
    try {
      ...
      if (data.success) {
        setRequests(
          data.data
            .filter((req: any) => req.type === RequestType.RESEARCH)
            .map((req: any) => ({
              id: req.id,
              title: req.title,
              status: req.status,
  ...
  return (
    <div className="min-h-screen bg-gray-50 p-8">
      <div className="max-w-6xl mx-auto">
        {/* Header */}
        <div className="mb-8">
          <h1 className="text-4xl font-bold text-gray-900 mb-2">Research Request</h1>
          <p className="text-gray-600">Kelola pengajuan riset Anda</p>
        </div>
        ...
        {showForm ? (
          <div className="mb-12">
            ...
            <ResearchForm onSuccess={() => setShowForm(false)} />
          </div>
        ) : (
          <div className="mb-12">
            <button
